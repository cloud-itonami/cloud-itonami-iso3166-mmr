(ns marketentry.phase
  "Phase 0->3 staged rollout for the MMR market-entry compliance
  actor.
    ...
    Phase 3  supervised auto  -- governor-clean, high-confidence
                                 `:engagement/intake` (no MyCo/MIC
                                 filing-facing risk yet) may auto-commit.
  ...
  real MyCO Annual Return / MIC filing package and submitting it are
